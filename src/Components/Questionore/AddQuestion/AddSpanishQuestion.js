...
const AddSpanishQuestion = (props) => {
    ...
    <Formik
      ...
      onSubmit={(values, actions) => {
        ...
        currentSpanishQuestionServices
          ...
          .then((res) => {
            currentSpanishQuestionServices.handleCustomMessage(
              "Added Successfully"
            );
          });
      }}
          ...
          <div class="container add-question">
            <div class="row mb-3">
              <div class="col-12 mt-5 heading">
                <h1 class="ml-10 p-0">Add Spanish Questions</h1>
              </div>
            </div>
            <form>
              <div class="mb-3">
...
export default AddSpanishQuestion;
